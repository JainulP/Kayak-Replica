                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-sm-3 col-xs-3 hotelFields">
                            <input type="text" className="form-control" value="1 room,3 guests" id="roomInfoTxtBox"
                                   readOnly onFocus={() => this.showHideChangePopUpjQ("show")}/><i
                            className="glyphicon glyphicon-user usericon" onClick={() => this.popUpDisplay()}></i>
                            <div id='div_change_qty' name='div_change_qty'>
                                <table width='100%' height='100%'>
                                    <tbody>
                                    <tr>
                                        <td width='50%'>Occupancy</td>
                                        <td width='20%'>
                                            <button type="button" className="hideBtn">
                                                +
                                            </button>
                                        </td>
...
<span className="spanClose" onClick={() => this.popUpClose()}><b>X</b>
                                    ...
                                    <tr className="borderclassName">
                                        ...
                                        <td width='10%'>
                                            <button type="button" id="addRoomBtn" onClick={() => this.addRoom()}
                                        ...
                                        <td width='10%'>
                                            <button type="button" className="btn btn-default" id="removeRoomBtn"
                                    ...
                                    <tr className="borderclassName">
                                        ...
                                        <td width='10%'>
                                            <button type="button" id="addAdultBtn" onClick={() => this.addAdult()}
                                                    className="btn btn-default">
                                                +
                                            </button>
                                        </td>
                                        ...
                                        <td width='10%'>
                                            <button type="button" id="removeAdultBtn" className="btn btn-default"
                                                    onClick={() => this.removeAdult()}>
                                                -
                                            </button>
                                        </td>
                                    </tr>
