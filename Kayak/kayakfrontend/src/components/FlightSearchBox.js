            ...
            <div className="flightbootstrap-iso">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <button type="button" className="btn btn-default transferStyling"
                                onClick={() => this.swapValues()}>
                            <span className="glyphicon glyphicon-transfer"></span>
                        </button>
                        <div className="col-sm-2 col-xs-2 hotelFields" id="aaa">
                            <input className="form-control datepicker" id="date" name="date" placeholder="MM/DD/YYYY"
                                   type="date" onClick={() => this.myFunction()} />

                        </div>
                        <div className="col-sm-2 col-xs-2 hotelFields">
                            <input className="form-control datepicker" id="date1" name="date" placeholder="MM/DD/YYYY"
                                   type="date" onClick={() => this.myFunction()}  />

                        </div>

                        <div className="col-sm-2 col-xs-2 hotelFields">
                            <input type="text" className="form-control" value="1 adult,Economy" id="FlightInfoTxtBox"
                                   readOnly onFocus={() => this.showHideChangePopUpjQ("show")}/><i
                            className="glyphicon glyphicon-menu-down flightpopIcon"
                            onClick={() => this.popUpDisplay()}></i>
                            <div id='div_change_qty' name='div_change_qty'>
                                <table className='flightTableClass' width='100%' height='100%'>
                                    <tbody>
                                    <tr>
                                        <td width='50%'><b>Cabin Class</b></td>
                                        <td width='20%'>
                                            <button type="button" className="hideBtn btn btn-default">
                                                +
                                            </button>
                                        </td>
...
<span className="spanClose" onClick={() => this.popUpClose()}><b>X</b>
                                    ...
                                    <tr>
                                        <td width='50%'><span className="hoverClassFlightType"
                                                              onClick={() => this.changeFlightClass('Economy')}>Economy</span>
                                        </td>

                                        <td width='50%'><span className="spanClassFlightType"
                                                              onClick={() => this.changeFlightClass('Business')}>Business</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width='50%'><span className="hoverClassFlightType"
                                                              onClick={() => this.changeFlightClass('First')}>First</span>
                                        </td>
                                    </tr>
                                    </ tbody>
                                </table>
                                ...
                                <table className='flightTableClass' width='100%' height='100%'>
                                    <tbody>
                                    <tr>
                                        <td width='50%'><b>Travellers</b></td>

                                    </tr>


                                    <tr className="borderclassName">
                                        <td width='50%'>Adults <span className="ageSpan">  18-64</span></td>
                                        <td width='10%'>
                                            <button type="button" id="addAdultBtn"
                                                    onClick={() => this.addTraveller('addAdultBtn', 'adultTextBtn', 'removeAdultBtn')}
                                                    className="btn btn-default">
                                                +
                                            </button>
                                        </td>
                                        <td width='10%' className="spanText"><span id="adultTextBtn"
                                                                                   className="spanText">1

</span></td>
                                        <td width='10%'>
                                            <button type="button" className="btn btn-default" id="removeAdultBtn"
                                                    onClick={() => this.removeTraveller('removeAdultBtn', 'adultTextBtn', 'addAdultBtn')}>
                                                -
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr className="borderclassName">
                                        <td width='50%'>Seniors <span className="ageSpan">  65+</span></td>
                                        <td width='10%'>
                                            <button type="button" id="addSeniorBtn"
                                                    onClick={() => this.addTraveller('addSeniorBtn', 'seniorTextBtn', 'removeSeniorBtn')}
                                                    className="btn btn-default">
                                                +
                                            </button>
                                        </td>
                                        <td width='10%' className="spanText"><span id="seniorTextBtn"
                                                                                   className="spanText">0

</span>
                                        </td>
                                        <td width='10%'>
                                            <button type="button" id="removeSeniorBtn" className="btn btn-default"
                                                    onClick={() => this.removeTraveller('removeSeniorBtn', 'seniorTextBtn', 'addSeniorBtn')}>
                                                -
                                            </button>
                                        </td>
                                    </tr>
                                    ...
                                    <tr className="borderclassName">
                                        <td width='50%'>Youth <span className="ageSpan">  12-17</span></td>
                                        <td width='10%'>
                                            <button type="button" id="addYouthBtn" className="btn btn-default"
                                                    onClick={() => this.addTraveller('addYouthBtn', 'youthTextBtn', 'removeYouthBtn')}>
                                                +
                                            </button>
                                        </td>
                                        <td width='10%' className="spanText"><span id="youthTextBtn"
                                                                                   className="spanText">
0
</span>
                                        </td>
                                        <td width='10%'>
                                            <button type="button" id="removeYouthBtn" className="btn btn-default"
                                    ...
                                    <tr>
                                        <td width='50%'>Child <span className="ageSpan">  0-11</span></td>
                                        <td width='10%'>
                                            <button type="button" id="addChildrenBtn" className="btn btn-default"
                                                    onClick={() => this.addTraveller('addChildrenBtn', 'childrenTextBtn', 'removeChildrenBtn')}>
                                                +
                                            </button>
                                        </td>
...
0
                                        ...
                                        <td width='10%'>
                                            <button type="button" id="removeChildrenBtn" className="btn btn-default"
